...
export const Features: ComponentConfig<FeaturesProps> = {
  ...
  defaultProps: {
    label: "- FEATURE 1",
    title: "All your work is safe with ",
    titleHighlightedText: "us",
    description: "We take your data security seriously, which is why we use advanced encryption protocols to protect your files in the cloud. Your data is safe and secure with us.",
    button: {
      text: "Try for free",
      link: "#try-for-free",
      show: true
  ...
  render: ({ label, title, titleHighlightedText, description, button }) => {
    return (
      <section className="w-full pt-24 px-4 pb-12 md:pb-0">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
          {/* Image Section */}
          <div className="w-full md:w-1/2 flex justify-center">
            <img 
              src="/images/template-blocks-placeholders/feature1.png"
